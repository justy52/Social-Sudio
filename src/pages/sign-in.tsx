    ...
    <main className="flex min-h-screen items-center justify-center bg-transparent px-4 py-10">
      <section className="w-full max-w-md space-y-5">
        <div className="relative overflow-hidden rounded-lg border border-primary/15 bg-card/60 p-5 text-center shadow-[0_22px_70px_rgba(2,6,23,0.36)] backdrop-blur-xl">
          <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(56,189,248,0.16),transparent_34%)]" />
          ...
          <p className="relative mt-1 text-sm text-muted-foreground">AI command center access</p>
        </div>
        <SignIn path="/sign-in" routing="path" signUpUrl="/sign-up" appearance={authAppearance} />
      </section>
    </main>
  );
}
